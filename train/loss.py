...
def loss(labels, bBoxes, totalBBoxes):
    ...
    groundTruthLabels = tf.placeholder(tf.int32, [None, totalBBoxes])
    ...
    classLoss = tf.nn.sparse_softmax_cross_entropy_with_logits(logits = labels, labels = groundTruthLabels) * sample
